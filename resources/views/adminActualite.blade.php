<div class="conta">
    <div class="lop">
        <div class="div">
            <h2> NEXT ONE : ACTUALITES</h2>

            <a href="{{route('ajoutActual')}}" class="b"> AJOUTER</a>
        ...
        <ul>
            ...
            <li>
                <h6 class="num">{{$produit->id}}</h6><span>Titre</span><br><br>{{$produit->titre}}
            </li>
            ...
            <li> <a class='voir pl' href="{{route('voir-actual',['id'=>$produit->id])}}">VOIR</a> <a class="ed bb pl"
                    href="{{route('update-actual',['id'=>$produit->id])}}">EDITER</a> <br>
                <a id="sup" class="supp" href="{{route('supp-actual',['id'=>$produit->id])}}"
