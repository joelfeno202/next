<div class="conta">
    <div class="lop">
        <div class="div">
            <h2> NEXT ONE :LISTES COMMANDES</h2>
        ...
        <ul>
            ...
            <li>
                <h6 class="num">{{$produit->id}}</h6><span>Nom</span><br><br>{{$produit->nom}}
            </li>
            ...
            <li>
                <a class='voir pl'
                    href="{{route('voir-commande',['id'=>$produit->id,'user_id'=>$produit->user_id])}}">VOIR</a>
                <!-- <a class="ed bb pl"
                    href="{{route('update-produit',['id'=>$produit->id])}}">EDITER</a> <br>-->
                <a id="sup" class="supp"
                    href="{{route('supp-commande',['id'=>$produit->id,'user_id'=>$produit->user_id,'created_at'=>$produit->created_at])}}"
