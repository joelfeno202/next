<div class="conta">
    <div class="lop">
        <div class="div">
            <a href="actual" class="ret"> <img class="rett" style="cursor: pointer;"
        ...
        <ul>
            ...
            <li class="nge"><span> IMAGE</span> <br> <br><img class="imgg" src="{{asset($post->image)}}" height='90%'
                    width='100%' alt="ff"></li>



            <li class="nge"><span> DESCRIPTION</span> <br><br>{{$post->description}}</li>
