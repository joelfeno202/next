<div class="conta">
    <div class="lop">
        <div class="div">
            <h2> NEXT ONE : Carousel</h2>

            <a href="{{route('ajout-post')}}" class="b"> AJOUTER</a>
        ...
        <ul>
            ...
            <li>
                <h6 class="num">{{$post->id}}</h6><span>Nom</span><br><br>{{$post->nom}}
            </li>
            <li><span> Image</span> <br><br><img class='imag' src="{{asset($post->image)}}" alt="ff">
            </li>

            <!--  <a href="{{route('voir-post',['id'=>$post->id])}}">VOIR</a>-->
            <li> <a class="ed bb" href="{{route('update-post',['id'=>$post->id])}}">EDITER</a> <br>
                <a id="sup" class="supp" href="{{route('supprimer-post',['id'=>$post->id])}}"
