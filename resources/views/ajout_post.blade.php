<div class="cont">
    <div class="div">
        ...
        <h2> AJOUT:Carousel</h2>
    </div>

    <form action="{{route('ajout-post')}}" method='post' enctype="multipart/form-data">
        @csrf

        <p><span> NOM</span> <input type="text" name='nom' placeholder='Entrer nom' required></p>
